...
object PureMovieServerApp extends StreamApp[IO] {
  ...
  private def pureMovieServerModule[F[_]: Concurrent](imbdAlgebraConfig : IMDBAlgebraConfig, gmailConfig: GmailConfig, transactor: Transactor[F]): F[ModulePureMovieServer[F]] =
